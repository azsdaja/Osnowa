namespace Libraries.PathPlannersLib
{
    ...
    public class DepthFirstSearch : SearchAlgorithm
    {
        ...
        public DepthFirstSearch(bool[,] unpassableNodes) : base(unpassableNodes) { }
        ...
        public List<Point> FindPath(Point start, Point goal, Functions.Function moveCostFunction, out uint pathCost, 
			out int nodesOpen, out int nodesClosed)
        {
