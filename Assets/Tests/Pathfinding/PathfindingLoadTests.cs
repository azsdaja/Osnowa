namespace Tests.Pathfinding
{
	...
	public class PathfindingLoadTests
	{
		...
		public void PrintTestedMaps()
		{
			int xSize = 500;
			int ySize = 500;
			var density = TestGrid.GridDensity.Medium;
			bool hasWalls = true;
			int seed = 333;

			var gip = new TestGrid(xSize, ySize, density, hasWalls, seed);
...
*/
		...
		private Position GetRandomWalkablePosition(RandomNumberGenerator rng, TestGrid gip)
		{
			Position position;
			do
			{
