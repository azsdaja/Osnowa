...
namespace Assets.Plugins.TilemapEnhancements.Brushes.Tint_Brush_Smooth.Scripts
{
	[ExecuteInEditMode]
	public class TintTextureGenerator : MonoBehaviour
	{
		...
		GridInformation.Scripts.GridInformation GetGridInformation(Grid grid)
		{
			GridInformation.Scripts.GridInformation gridInformation = grid.GetComponent<GridInformation.Scripts.GridInformation>();

			if (gridInformation == null)
				gridInformation = grid.gameObject.AddComponent<GridInformation.Scripts.GridInformation>();
